<div class="w-full items-center flex-col flex justify-center shadow-sm">
    <img class="w-4/5" src="footer.png" alt="Footer Image">
  
  <hr class="border-b-2 border-gray-200 w-full"/>
  ...
  <div class="w-full flex flex-col md:flex-row my-16 items-center justify-center text-center">
    ...
    <div class="w-full md:w-1/4 mb-8 md:mb-0 px-4 flex flex-col items-center justify-center text-center">
      ...
      <p class="text-center">Driving Success and Growth with <br>Tailored Tech Solutions</p>
    </div>
  
    <!-- follow us -->
    <div class="w-full md:w-1/4 mb-8 md:mb-0 px-4 flex flex-col items-center justify-center text-center">
      <h2 class="text-xl mb-4 font-medium">Follow us</h2>
      <div class="flex flex-row justify-center items-center">
<!-- Facebook -->
<a href="https://www.facebook.com/sealnext" target="_blank">
...
<!-- LinkedIn -->
<a href="https://www.linkedin.com/company/sealnext" target="_blank">
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24">
...
<!-- Instagram -->
<a href="https://www.instagram.com/seal.next" target="_blank">
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24">
