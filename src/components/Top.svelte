...
<div class="flex flex-col">
  <div class="shadow-md w-full">
    <div
      class="h-14 mx-24 max-sm:mx-4 sm:max-md:mx-6 md:max-lg:mx-12 flex flex-row items-center"
    >
      <div class="grow font-medium text-lg">SEALNEXT</div>
  ...
  >
    ...
    <img src="/big_seal.png" alt="Big Seal" class="mt-20 h-96 object-contain" />
  </div>
</div>
