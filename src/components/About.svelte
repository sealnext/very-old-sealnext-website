<!-- TABLET/DESKTOP -->
<section class="flex py-10 md:py-16 lg:py-20 mx-[5vw] flex-col items-center justify-between">
  <div class="text-center text-[1.2rem] md:text-[1.5rem]">We're not just a tech company, we're your trusted digital journey partner.</div>
  ...
  <div class="flex items-center justify-between pt-6 md:pt-12 lg:pt-20 flex-col md-[1rem] md:mx-[5rem] gap-10">
    ...
    <div id="servicess" class="flex gap-10 flex-col md:flex-row justify-between items-center">
      <div class="flex w-full flex-col text-left service">
        <div class="flex items-center font-medium text-[1.7rem]"><span class="material-symbols-outlined mr-2">web</span>Web Development</div>
        <div class="text-[1.1rem] md:text-[1.3rem] font-normal">We create SEO-friendly, mobile-optimized websites that convey your brand message and captivate your audience.</div>
      </div>
