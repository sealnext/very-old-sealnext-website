...
<section class="px-[5vw] justify-between max-md:hidden mt-16 flex flex-row">
  <div class="w-1/2 flex flex-col justify-center">
    ...
    <div class="py-3 flex flex-col md:flex-row gap-2 px-[2rem] sm:px-0 w-full sm:w-auto">
      <a href="#free" class="freeButton bg-black font-medium text-white rounded-[10px] py-3 px-4 border-2 border-black text-[1rem] w-full md:w-auto">Claim your FREE solution</a>
